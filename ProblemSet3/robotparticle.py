...
class robot:
    ...
    def move(self, motion): # Do not change the name of this function
        ...
        x_prime += random.gauss(0.0, new_robot.distance_noise)
        y_prime += random.gauss(0.0, new_robot.distance_noise)

        orientation_prime = (new_robot.orientation + beta) + random.gauss(0.0, new_robot.bearing_noise)
        orientation_prime %= (2*pi)
    ...
    def sense(self, add_noise = 1): #do not change the name of this function
        ...
        myrobot2.x = self.x
        myrobot2.y = self.y
        myrobot2.orientation = self.orientation
        myrobot2.length = self.length
        myrobot2.bearing_noise = self.bearing_noise
        myrobot2.steering_noise = self.steering_noise
        myrobot2.distance_noise = self.distance_noise
