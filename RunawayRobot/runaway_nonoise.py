...
def estimate_next_pos(measurement, OTHER = None):
    ...
    if OTHER is None:
        ...
        if 'last_heading' not in OTHER:
            ...
            #dx = D*sin(theta)
            #dy = D*cos(theta)
            delta_x = D * sin(heading+turning_angle)
            delta_y = D * cos(heading+turning_angle)
            ...
            #THIS ONLY WORKS IN A NON-NOISY, PERFECT WORLD
